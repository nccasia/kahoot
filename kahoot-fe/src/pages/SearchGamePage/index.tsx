...
const SearchGamePage = () => {
  ...
  const handleSearchGame = () => {
    ...
    if (!socket) {
      toast.error(
        // "Không thể kết nối đến máy chủ, vui lòng đóng ứng dụng và thử lại"
        "Cannot connect to the server, please close the app and try again"
      );
      return;
    }
        ...
        <div className="w-full max-w-[400px] min-h-[150px] bg-[#ba85ff] rounded-lg flex-col flex items-center justify-center p-4 font-coiny">
          ...
          <div className="flex w-full gap-2 justify-center">
            <Button
              ...
              className="text-[20px] mt-2 bg-[#d43d3d]"
            >
              {/* Quay lại */}
              Back
            </Button>
