...
const TextQuestionAnalyst = ({
  currentQuestion,
  questionAnalyst,
  correctAnswers,
}: ITextQuestionAnalystProps) => {
  return (
    <div className="p-2 w-full h-full">
      ...
      >
        ...
        <div
          className="bg-[#5d017e] w-full p-2 mt-2"
          style={{
        ...
        >
          <div className="bg-[#5d017e] sticky -top-1 z-11 h-[50px] flex items-center justify-center text-white font-coiny">
            <span className=" p-2 border-b-2 border-white ">
              {/* Đáp án đã gửi lên */}
              Submitted Answers
            </span>
          </div>
          <div className="min-h-[200px] mt-2">
            <div className="bg-[#5d017e] sticky z-10 top-[45px] flex items-center justify-between w-full min-h-[50px]">
              <div className="flex-1">
                <span className=" p-1 border-b-[1px] border-white">
                  {/* Đáp án */}
                  Answer
                </span>
              </div>
            ...
            {questionAnalyst.map((analyst, index) => (
              <div
                key={index}
                className="flex items-center justify-between w-full min-h-[40px] mb-2"
              >
                <div className="flex-1">
