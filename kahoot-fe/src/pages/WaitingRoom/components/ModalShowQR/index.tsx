  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel} showHeader={false}>
      <div
        ...
        style={{ aspectRatio: 1 }}
      >
        <p className="max-w-[300px] text-center mb-3 font-coiny">
          {/* Hãy quét mã QR bên dưới bằng ứng dụng Mezon để tham gia trò chơi */}
          Please scan the QR code below with the Mezon app to join the game
        </p>
        <QRCodeSVG
          value={((): string => {
            ...
            return `${ENV.MEZON_URL}/channel-app/${urlData.channelId}/${
              urlData?.clanId
            }?${params.toString()}`;
          })()}
          fgColor="white"
