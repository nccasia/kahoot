...
const GameItem = ({ game }: GameItemProps) => {
  ...
  return (
    <div onClick={handleGoToGameDetail} className='min-h-[150px] flex items-center justify-center'>
      <div className='max-w-[500px] px-2 w-full h-full text-white bg-[#466CF7] border-[0.2rem] border-[#533ECF] font-coiny rounded-[20px] relative text-2xl flex justify-center items-center cursor-pointer hover:bg-[#385ad6bf] hover:border-[#0026d2] active:bg-[#466CF7] transition-all select-none'>
